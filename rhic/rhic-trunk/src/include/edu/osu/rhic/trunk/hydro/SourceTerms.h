...
const DYNAMICAL_SOURCE * const __restrict__ Source, const PRECISION * const __restrict__ rhobvec, const PRECISION * const __restrict__ muB, PRECISION muBp, const PRECISION * const __restrict__ T, PRECISION Tp//Part & rhob by Lipei
);
